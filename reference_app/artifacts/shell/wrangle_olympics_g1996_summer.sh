...
echo ''
echo 'first line of input file: tmp/olympics/olympics__g1996_summer.json'
head -1 tmp/olympics/olympics__g1996_summer.json

echo ''
echo 'first line of output file: tmp/olympics/olympics__g1996_summer__wrangled.json'
