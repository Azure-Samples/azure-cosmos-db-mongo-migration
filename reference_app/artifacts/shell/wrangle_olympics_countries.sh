...
echo ''
echo 'first line of input file: tmp/olympics/olympics__countries.json'
head -1 tmp/olympics/olympics__countries.json

echo ''
echo 'first line of output file: tmp/olympics/olympics__countries__wrangled.json'
...
then
    ...
    mongoimport \
        ...
        --file tmp/olympics/olympics__countries__wrangled.json \
...
then
    ...
    dotnet run --project dotnet_mongo_loader/dotnet_mongo_loader.csproj \
        olympics locations tmp/olympics/olympics__countries__wrangled.json \
...
then
    ...
    rm tmp/olympics/olympics__countries.json
