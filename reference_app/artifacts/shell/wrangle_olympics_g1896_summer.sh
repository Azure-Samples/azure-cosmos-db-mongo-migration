...
echo ''
echo 'first line of input file: tmp/olympics/olympics__g1896_summer.json'
head -1 tmp/olympics/olympics__g1896_summer.json

echo ''
echo 'first line of output file: tmp/olympics/olympics__g1896_summer__wrangled.json'
